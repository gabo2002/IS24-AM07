...
/**
 * Represents the CLI (Command Line Interface) representation of a small objective card.
 * <p>
 * This class extends CLIObjectiveCardRepresentation.
 * </p>
 */
public class CLISmallObjectiveCardRepresentation extends CLIObjectiveCardRepresentation {

    /**
     * The width of the small objective card representation.
     */
    public static final int WIDTH = 11;

    /**
     * The height of the small objective card representation.
     */
    ...
    /**
     * Returns the width of the small objective card representation.
     *
     * @return the width of the small objective card.
     */
    @Override
    public int width() {
        return WIDTH;
    ...
    /**
     * Returns the height of the small objective card representation.
     *
     * @return the height of the small objective card.
     */
    @Override
    public int height() {
        return HEIGHT;
